...
"[project]/front/sections/Reviews.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Reviews() {
    ...
    const items = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Reviews.useMemo[items]": ()=>{
            const reviews = shuffle(REVIEWS.map({
                "Reviews.useMemo[items].reviews": (r)=>({
                        kind: "review",
                        ...r
                    })
            }["Reviews.useMemo[items].reviews"]), 31);
...
_s(Reviews, "RyGd+B/XCFLvyh2mI5WNvQB4DlM=");
_c = Reviews;
var _c;
...
//# sourceMappingURL=front_302b5e1b._.js.map