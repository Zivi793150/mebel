...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Конечно! Мы успешно реализуем проекты по всей РФ и даже за рубежом. Нужно прислать фото окна в вашем интерьере и примерные размеры. Далее с вами свяжется наш дизайнер, который согласует желаемый вариант оформления, пришлет фото и видео образцов, а также инструкцию, как правильно замерить окно, чтобы исключить возможность ошибки. Если потребуется, мы можем направить нашего представителя в ваш город для исполнения заказа. Рассчитываем стоимость, если Вас все устраивает, то переходим к оплате и оформлению заказа. Или вносим изменения, прорабатывая заказ, пока Вы не получите именно тот вариант, что хотели! После подписания договора и внесения предоплаты Ваш заказ отправится на производство. В обозначенные сроки мы отправим готовые изделия, аккуратно и надежно упакованные, выбранной Вами транспортной компанией. Вам останется только повесить шторы и наслаждаться ими!",
  },
];
