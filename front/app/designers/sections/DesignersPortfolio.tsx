...
const portfolioItems = [
  ...
  {
    title: "Игра света",
    cover: enc("/for_designers/light play/FullSizeRender (2).webp"),
    images: [
      enc("/for_designers/light play/FullSizeRender (2).webp"),
      enc("/for_designers/light play/FullSizeRender (3).webp"),
      enc("/for_designers/light play/FullSizeRender (4).webp"),
      enc("/for_designers/light play/FullSizeRender (6).webp"),
      enc("/for_designers/light play/FullSizeRender (9).webp"),
      enc("/for_designers/light play/FullSizeRender (12).webp"),
    ],
  },
];
