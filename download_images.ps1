# PowerShell script to download images from centrshtor.ru
$baseUrl = "https://centrshtor.ru"
$outputDir = "c:\Users\zivi7\mebel\front\public\electro"

# List of all image URLs from the parsed HTML
$images = @(
    ...
    "/upload/iblock/530/cj1yslfwwrw97eoz3mwlr9ooq322yzb3.jpg",
    ...
    # Type 3: Раздвижной угловой (7 images)
    "/upload/iblock/749/d26trwzyg56pm5qsw5dwfqrjsl4ub9f0.jpg",
    ...
    # Type 4: Раздвижной радиальный (6 images)
    "/upload/iblock/8c5/e4vvaub4qyq8lbeatdergktn89vfbnfb.jpg",
    ...
    # Type 5: Раздвижной на люверсах (4 images)
    "/upload/iblock/471/1o3bysw2k7990ir6z5kaor4o0316b0ci.jpg",
    ...
    # Type 6: Римский (5 images)
    "/upload/iblock/6e7/n1szfwy3h7bjh185fguzcsifxq69m1dp.jpg",
    ...
    # Type 7: Римский день-ночь (4 images)
    "/upload/iblock/fb4/janr06n307vnsaikabt3tquoq2wm5dwq.jpg",
    ...
    # Type 8: Римский наклонный (5 images)
    "/upload/iblock/453/w8w0qhhjz1asugmb2ck5tu6lzxrbjc6a.jpg",
    ...
    # Type 9: Рулонный с соединителем (5 images)
    "/upload/iblock/8a0/ecujr9pjg6z2493790j47qeu0zn515nd.jpg",
    ...
    # Type 10: Рулонный UNI2 (4 images)
    "/upload/iblock/757/e5rptf6vmzn0crp5wvph0wd6lwplzc1x.jpg",
    ...
    # Type 11: Рулонный открытого типа (4 images)
    "/upload/iblock/f9e/qtdx2hb7kh7z831q2fl1zew3uvvtkm9b.jpg",
    ...
    # Type 12: Рулонный день-ночь (6 images)
    "/upload/iblock/81a/9ly0rcdxw0lv83pk4ntvrg3rs5fl0a0l.jpg",
    ...
    # Type 13: Рулонный зебра в коробе (4 images)
    "/upload/iblock/2da/87dftq9sroixbke0bdo4g23hp8qu8j18.jpg",
    ...
    # Type 14: Электрокарниз для горизонтальных жалюзи (3 images)
    "/upload/iblock/030/2cxzcnwpb2pbec67lhut5dk0tfr1jpdj.jpg",
    "/upload/iblock/636/6cq4m1cnzogcrr377o67ku1mi5gdg3pv.png",
    "/upload/iblock/871/s8bmeeqjyl3ma0w3b1rrlyfmbdqii2sj.png",
    
    # Type 15: Электрокарниз для вертикальных жалюзи (6 images)
    "/upload/iblock/3da/bpdkjbcq6bw5d2sduk4wsssqrrao7axn.jpg",
    ...
    # Type 16: Электрокарниз для штор плиссе (6 images)
    "/upload/iblock/341/grvtvg899kzl5bcsmeftyl93m7aft8u2.jpg",
    ...
    # Type 17: Электрокарниз для пергол (4 images)
    "/upload/iblock/45d/308a0bfrbag3qjn00dl87rd0n735kqz9.jpg",
    ...
    # Type 18: Подъёмный механизм лифт-система (3 images)
    "/upload/iblock/b12/zf56d1c6163bk26r6tmx33e8quu27ez8.jpg",
...
foreach ($img in $images) {
    ...
    try {
        Invoke-WebRequest -Uri $url -OutFile $outputPath -TimeoutSec 30 -ErrorAction SilentlyContinue
